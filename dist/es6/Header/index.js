	...
	babelHelpers.createClass(Header, [{
		...
		value: function render() {
			...
			return React.createElement(
				'div',
				{ className: classNames(style.root, (_classNames = {}, babelHelpers.defineProperty(_classNames, style.blank, !selectedDates), babelHelpers.defineProperty(_classNames, style.landscape, layout == 'landscape'), _classNames)), style: theme && { backgroundColor: theme.headerColor, color: theme.textColor.active } },
				selectedDates ? React.createElement(
					'div',
